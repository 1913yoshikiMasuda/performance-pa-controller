...
- Sourceマーカーを掴んだままドラッグして、発火せずに連続定位
...
Stage左上で2D / 3Dを切り替えられます。Sourceマーカーを掴んだドラッグは音源の連続移動、空き領域の短いタップは発火、空き領域のドラッグは視点回転です。Zフェーダーも発火せずに定位を更新します。ピンチまたはマウスホイールでズームし、ISO / FRONT / SIDE / TOPで視点を即座に切り替えられます。Speaker Layoutも同じカメラ状態と操作を共有します。
